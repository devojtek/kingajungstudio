<section class="about-us" id="aboutus">
	<div class="container">
		...
		<div class="row">
			...
			switch (
				...
				if( !empty($zerif_aboutus_biglefttitle) ):
					...
					echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' columnAboutUs zerif-rtl-big-title">';
			...
			if( !empty($zerif_aboutus_text) ):
				...
				echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' columnAboutUs zerif_about_us_center" data-scrollreveal="enter bottom after 0s over 1s">';
		...
		<div class="col-lg-<?php echo $colCount; ?> col-md-<?php echo $colCount; ?> columnAboutUs zerif-rtl-skills ">
